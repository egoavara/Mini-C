...
public class Token {
    ...
    public static Token mkSingleComment(String comment) {
        return new Token(TokenType.SingleLineComment, comment);
    }
    public static Token mkMultiComment(String comment) {
        return new Token(TokenType.MultiLineComment, comment);
    }
    public static Token mkDocumentedComment(String comment) {
        return new Token(TokenType.DocumentedComment, comment);
    }
